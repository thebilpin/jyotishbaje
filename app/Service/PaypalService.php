...
class PaypalService
{
    ...
    public function processPaypalRequest($request)
    {
        ...
        // dd($cancelReturn,$notifyUrl,$returnTo);
        ...
        $customData = json_encode(['orderId' => $orderId, 'pay_id' => $pay_id]);


        // Build the query string from the data.
        $paypalUrl     .= "?cmd=_xclick&upload=1&display=1&add=1&charset=utf-8&currency_code=$currency&business=$businessEmail&cancel_return=$cancelReturn&notify_url=$notifyUrl&rm=2&amount=$orderTotalAmount&item_name=$itemName&return=$returnTo&custom=" . urlencode($customData) . "&invoice=$orderId&pay_id=$pay_id";
