                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                            <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                                <a href="<?php echo e(route('front.dailyHoroscope',['slug' => $horoscopesign['slug']])); ?>"
                                    title="<?php echo e($horoscopesign['name']); ?>" class="text-decoration-none text-dark">
                                    <div>
                                        <img style="height: 110px;width:110px" src="<?php echo e(Str::startsWith($horoscopesign['image'], ['http://','https://']) ? $horoscopesign['image'] : '/' . $horoscopesign['image']); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($horoscopesign['image']); ?>')" />
                                    </div>
                                    <div class="">
                        ...
                        <div class="text-center d-flex font-weight-medium align-items-center w-100 px-sm-4 pr-2 pr-sm-5">
                            <div class="px-2 w-100 px-lg-5 mx-lg-5">
                                ...
                                <a href="<?php echo e(route('front.chatList')); ?>"
                                    ...
                                    An <?php echo e(ucfirst($professionTitle)); ?> Now</a>
                            </div>
                        </div>
                        <div
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astropackage\resources\views/frontend/pages/horoscopesign.blade.php ENDPATH**/ ?>