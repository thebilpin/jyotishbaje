                                        ...
                                        <li class="w-100 colorblack">
                                            ...
                                            ${astrologer.emergencyCallStatus ? `
                                              <span class="font-13 font-weight-semi-bold d-flex">
                                                    <img src="<?php echo e(asset('public/frontend/homeimage/rupee-coin-outline-icon.svg')); ?>" height="16" width="16" alt="">&nbsp; &nbsp;
                                            ...
                                            `: (astrologer.isFreeAvailable) ? `
                                                <span class="font-13 font-weight-semi-bold d-flex">
                                                    <span class="exprt-price">
                                                        <img src="<?php echo e(asset('public/frontend/homeimage/rupee-coin-outline-icon.svg')); ?>" height="16" width="16" alt="">&nbsp; <del> ${astrologer.charge}</del>/Min
                                                    </span>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="kundli-card shadow d-none d-md-block" data-aos="fade-right" data-aos-delay="200">
                        <a href="<?php echo e(route('front.getkundali')); ?>"><img src="<?php echo e(asset('public/frontend/homeimage/home-analyze.png')); ?>" alt="Sage Icon"></a>
                    </div>
                </div>
...
<!-- ================= HOROSCOPE SECTION END ================= -->
                ...
                <?php $__currentLoopData = $Productlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="vedic-card"
                            ...
                            <h2 class="font-weight-semi text-start font-22 mb-2"><?php echo e($product->name); ?></h2>
                            ...
                            <span class="vedic-product-img" style="mask-image: linear-gradient(white, white, transparent);">
                                <img class="vedic-image mb-3" style="max-width: 100%; height: 200px; object-fit: contain;" src="<?php echo e(Str::startsWith($product->profileImage, ['http://','https://']) ? $product->profileImage : '/' . $product->profileImage); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($product->profileImage); ?>')" />
                            </span>
                            <div class="vedic-product-footer">
                                <p class="vedic-price mb-3">Selling at 
                                    <?php if($walletType == 'coin'): ?>
                                                    ...
                                                    <?php endif; ?>
                                    <?php echo e($product->amount); ?></p>
                                <a href="<?php echo e(route('front.getproductDetails', ['slug' => $product->slug])); ?>" class="vedic-button btn btn-dark w-100">Buy Now</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(isset($astrotalkInNews) && count($astrotalkInNews) > 0): ?>
                ...
                <?php $__currentLoopData = $astrotalkInNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item">
                            <div class="video-card">
                                <img style="height:160px;" alt="Video 1" class="video-thumbnail" src="<?php echo e(Str::startsWith($news->bannerImage, ['http://','https://']) ? $news->bannerImage : '/' . $news->bannerImage); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($news->bannerImage); ?>')" />
                                <div class="video-title"><?php echo e($news->channel); ?></div>
                                <a href="<?php echo e(route('news.show', $news->id)); ?>" class="btn btn-primary btn-sm" style="display: block;">View More</a>
                            </div>
                        </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <section class="py-5 bg-white">
        <div class="container ">
            ...
            <div class="row justify-content-strat">
                    ...
                    <?php $__currentLoopData = $blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bloglist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div class="col-md-4 mt-4">
                        <a href="<?php echo e(route('front.getBlogDetails', ['slug' => $bloglist->slug])); ?>" class="text-decoration-none">
                            <div class="product-card parad-shivling shadow-sm overflow-hidden p-0">
                                <div class="position-relative" style="height:250px;">
                                    <img class="product-image position-absolute" style="top: 0; left: 0;" src="<?php echo e(Str::startsWith($bloglist->blogImage, ['http://','https://']) ? $bloglist->blogImage : '/' . $bloglist->blogImage); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($bloglist->blogImage); ?>')" />
                                </div>
                                <div class="p-3 text-left">
                                    <h3 class="font-weight-700"><?php echo e($bloglist->title); ?></h3>
                                    <p class="text-dark">
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astropackage\resources\views/frontend/pages/index.blade.php ENDPATH**/ ?>