            ...
            <div class="col-md-12 d-flex align-items-center">
                ...
                <span style="text-transform: capitalize; ">
                    <span class="text-white breadcrumbs">
                        ...
                        <i class="fa fa-chevron-right"></i> <span class="breadcrumbtext">Talk To <?php echo e(ucfirst($professionTitle)); ?></span>
                    </span>
                </span>
                            ...
                            <div class="mb-3 ">
                                ...
                                <form class="px-3 font-14" method="post" id="callintakeForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 py-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="Gender" name="gender" required>
                                                    <option value="Male" <?php echo e(isset($getIntakeForm['recordList'][0]['gender']) && $getIntakeForm['recordList'][0]['gender'] == 'Male' ? 'selected' : ''); ?>>Male</option>
                                                    <option value="Female" <?php echo e(isset($getIntakeForm['recordList'][0]['gender']) && $getIntakeForm['recordList'][0]['gender'] == 'Female' ? 'selected' : ''); ?>>Female</option>
                                                    <option value="Other" <?php echo e(isset($getIntakeForm['recordList'][0]['gender']) && $getIntakeForm['recordList'][0]['gender'] == 'Other' ? 'selected' : ''); ?>>Other</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6 py-2">
                                            <div class="form-group mb-0">
                                                ...
                                                <select class="form-control" id="MaritalStatus" name="maritalStatus" required>
                                                    <option value="Single" <?php echo e(isset($getIntakeForm['recordList'][0]['maritalStatus']) && $getIntakeForm['recordList'][0]['maritalStatus'] == 'Single' ? 'selected' : ''); ?>>Single</option>
                                                    <option value="Married" <?php echo e(isset($getIntakeForm['recordList'][0]['maritalStatus']) && $getIntakeForm['recordList'][0]['maritalStatus'] == 'Married' ? 'selected' : ''); ?>>Married</option>
                                                    <option value="Divorced" <?php echo e(isset($getIntakeForm['recordList'][0]['maritalStatus']) && $getIntakeForm['recordList'][0]['maritalStatus'] == 'Divorced' ? 'selected' : ''); ?>>Divorced</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <?php else: ?>
                                        <input type="hidden" name="call_duration" value="<?php echo e($getIntakeForm['default_time']); ?>">
                    ...
                    <div class="expert-search-form">
                        <div class="row mx-auto px-2 px-md-0 flex-md-nowrap align-items-center round">
                            <div
                                ...
                                <h1 class="font-22 font-weight-bold">Talk to <?php echo e(ucfirst($professionTitle)); ?></h1>
                            ...
                            <div class="col-ms-12 col-md-3 d-none d-md-block" id="searchExpert">
                                <form action="<?php echo e(route('front.talkList')); ?>" method="GET">
                                    <div class="search-box">
                                        <input value="<?php echo e(isset($searchTerm) ? $searchTerm : ''); ?>"
                                            class="form-control rounded" name="s"
                                            placeholder="Search <?php echo e(ucfirst($professionTitle)); ?>s" type="search" autocomplete="off">
                        ...
                        <ul class="list-unstyled d-flex mb-0">
                            <li class="mr-3 position-relative psychic-presence status-online" data-status="online">
                                ...
                                <div class="status-badge-txt text-center specific-Clr-Busy"><span
                                        id="" title="Online"
                                        class="status-badge-txt specific-Clr-Busy tooltipex"><?php echo e($astrologer['callStatus']); ?></span>
                                </div>
                                <?php elseif($astrologer['callStatus']=='Offline' || empty($astrologer['callStatus'])): ?>
                                <?php if($astrologer['callStatus']=='Offline' && $astrologer['emergencyCallStatus']): ?>
                                ...
                                <div class="status-badge-txt text-center specific-Clr-Offline"><span
                                        id="" title="Online"
                                        class="status-badge-txt specific-Clr-Offline tooltipex"><?php echo e($astrologer['callStatus'] ?? 'Offline'); ?></span>
                                </div>
                                <?php endif; ?>
                                <?php else: ?>
                            ...
                            <li class=" w-100 colorblack">
                                <!-- <?php if($astrologer->AstroFreePaid == 0): ?>
                                            <span class="badge bg-success" style="float: inline-end; color:#fff">Free</span>
                                        <?php elseif($astrologer->AstroFreePaid == 1): ?>
                                ...
                                <?php if($astrologer['emergencyCallStatus']): ?>
                                    ...
                                    <span
                                        ...
                                        <i class="fa-solid fa-phone mr-1"></i>
                                            <?php if($walletType == 'coin'): ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php echo e($astrologer['emergency_audio_charge']); ?></span><i
                                        class="fa-solid fa-video mt-1 mr-1"></i>
                                            <?php if($walletType == 'coin'): ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php echo e($astrologer['emergency_video_charge']); ?></span>
                                <?php elseif($isFreeAvailable == true): ?>
                                ...
                                <span class="font-13 font-weight-semi-bold d-flex"> &nbsp; &nbsp;
                                    <span
                                        ...
                                        <?php if($walletType == 'coin'): ?>
                                                    ...
                                                    <?php endif; ?>
                                    <?php echo e($astrologer['charge']); ?></span><i
                                        class="fa-solid fa-video mt-1 mr-1"></i>
                                       <?php if($walletType == 'coin'): ?>
                                                        <img src="<?php echo e(asset($coinIcon)); ?>" alt="Wallet Icon" width="15">
                                                    <?php else: ?>
                                                    ...
                                                    <?php endif; ?>
                                    <?php echo e($astrologer['videoCallRate']); ?></span>
                                <?php endif; ?>
                            </li>
                        </ul>
                            ...
                            <div class="d-block">
                                <div class="row">
                                    ...
                                    <div class="col-3 responsiveCallBtn mt-1">
                                        <?php if($astrologer['callStatus']=='Busy' || $astrologer['callStatus']=='Offline' || empty($astrologer['callStatus'])): ?>
                                        <?php if($astrologer['emergencyCallStatus'] && $astrologer['callStatus']=='Offline'): ?>
                                        ...
                                        <?php else: ?>
                                        <a class="btn-block btn btn-call  align-items-center " style="font-size: 14px !important;"><?php echo e($astrologer['callStatus'] ?? 'Offline'); ?></a>
                                        <?php endif; ?>
                                        <?php elseif($astrologer['call_sections']==0 || $Callsection['value']==0): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astropackage\resources\views/frontend/pages/astrologer-call-list.blade.php ENDPATH**/ ?>