    ...
    <div class="ds-head-populararticle bg-white cat-pages">
        <div class="container">
            ...
            <div class="row py-3 mt-4">
                <div class="col-12">
                    <h2 class="cat-heading font-24">
                        <?php if($tomorrowActive): ?>
                    ...
                    <p class="pt-3 text-center">Panchang is the Hindu calendar followed by Vedic astrology, which provides
                        ...
                        <?php echo e(ucfirst($professionTitle)); ?>s for hundreds of years. Through Daily Panchang, you can get all the information about the
                        time, date, and day to determine the Muhurat for everything. <?php echo e(ucfirst($professionTitle)); ?>s suggest people should
                                        ...
                                        <div class="shadow-pink rounded h-100">
                                            ...
                                            <div class="Choghadiya_img_day px-3 pt-3 font-14">
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['tithi']['name']); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['nakshatra']['name']); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['yoga']['name']); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['karana']['name']); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['rasi']['name']); ?></p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="shadow-pink rounded h-100">
                                            ...
                                            <div class="Choghadiya_img_day px-3 pt-3 font-14">
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['sun_rise']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['sun_set']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['moon_rise']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['moon_set']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['next_full_moon']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['next_new_moon']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['masa']['amanta_name']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['masa']['paksha']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['response']['advanced_details']['masa']['purnimanta_name']); ?></p>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astropackage\resources\views/frontend/pages/panchang.blade.php ENDPATH**/ ?>