...
@section('subhead')
<title>Puja Faq's</title>
@endsection

@section('subcontent')
<div class="loader"></div>
<h2 class="intro-y text-lg font-medium mt-10 d-inline">Puja Faq's</h2>
        ...
        <nav class="w-full sm:w-auto sm:mr-auto">
            <ul class="pagination">
                <li class="page-item {{ $page == 1 ? 'disabled' : '' }}">
                    <a class="page-link" href="{{ route('puja-faq-list', ['page' => $page - 1]) }}">
                        <i class="w-4 h-4" data-lucide="chevron-left"></i>
                    </a>
                </li>
                @for ($i = 0; $i < $totalPages; $i++)
                    <li class="page-item {{ $page == $i + 1 ? 'active' : '' }} ">
                        <a class="page-link" href="{{ route('puja-faq-list', ['page' => $i + 1]) }}">{{ $i + 1 }}</a>
                    </li>
                @endfor
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Add Puja Faq's</h2>
            </div>
            <form id="add-data" method="POST" enctype="multipart/form-data">
                ...
                <div id="input" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-5"><button class="btn btn-submit btn-primary shadow-md mr-2">Add Puja
                                Faq's</button>
                        </div>
                    </div>
                </div>
...
<div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Edit Puja Faq's</h2>
            </div>
            <form method="POST" enctype="multipart/form-data" action="{{ route('editPujaFaq') }}">
                @csrf
                <div id="input" class="p-5">
                    <div class="preview">
                        <div class="mt-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body p-0">
                ...
                <form action="{{ route('deletePujaFaq') }}" method="POST">
                    @csrf
                    @method('DELETE')
