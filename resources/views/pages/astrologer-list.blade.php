        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center">
            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
               ...
               <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-auto">
                <form action="{{ route('astrologers') }}" method="GET" enctype="multipart/form-data" id="filterForm">
                    <!-- From Date -->
...
@section('script')
    ...
    <script>
        ...
        document.getElementById('clearButton').addEventListener('click', function () {
            ...
            window.location.href = "{{ route('astrologers') }}"; // Redirect to remove query parameters
        });
    </script>
@endsection
