...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <form action="{{ route('ai.astrologers.chat.history') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="w-56 relative text-slate-500" style="display:inline-block">
                    ...
                    @else
                    <a href="{{ route('ai.astrologers.chat.history') }}"><i class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0"
                        data-lucide="x"></i></a>
                        @endif
                    </div>
             ...
             <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-auto">
                <form action="{{ route('ai.astrologers.chat.history') }}" method="GET" enctype="multipart/form-data" id="filterForm">
                    <!-- From Date -->
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    ...
                    <td class="text-center">
                        {{ number_format($chat->chat_rate,2) }}
                    </td>
                    <td class="text-center">
                    ...
                    @php
                    $durationInSeconds = $chat->chat_duration;
        ...
        <nav class="w-full sm:w-auto sm:mr-auto">
            <ul class="pagination" id="pagination">
                <li class="page-item {{ $page == 1 ? 'disabled' : '' }}">
                    <a class="page-link"
                    href="{{ route('ai.astrologers.chat.history', ['page' => $page - 1, 'searchString' => @$searchString]) }}">
            ...
            <li class="page-item">
                <a class="page-link"
                href="{{ route('ai.astrologers.chat.history', ['page' => 1, 'searchString' => @$searchString]) }}">1</a>
            </li>
            @if ($startPage > 2)
            ...
            <li class="page-item {{ $page == $i ? 'active' : '' }}">
                <a class="page-link"
                href="{{ route('ai.astrologers.chat.history', ['page' => $i, 'searchString' => @$searchString]) }}">{{ $i }}</a>
            </li>
            @endfor
            ...
            <li class="page-item">
                <a class="page-link"
                href="{{ route('ai.astrologers.chat.history', ['page' => $totalPages, 'searchString' => @$searchString]) }}">{{ $totalPages }}</a>
            </li>
            @endif
...
<script>
    ...
    document.getElementById('clearButton').addEventListener('click', function () {
        ...
        window.location.href = "{{ route('ai.astrologers.chat.history') }}"; // Redirect to remove query parameters
    });
</script>
@endsection
