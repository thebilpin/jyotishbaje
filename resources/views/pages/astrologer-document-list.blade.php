...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10 d-inline">{{ucfirst($professionTitle)}} Document List</h2>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Add Document List </h2>
                </div>
                ...
                <div id="form-validation" class="p-5">
                    <div class="preview">
                        ...
                        <div id="success-notification-content" class="toastify-content hidden flex">
                            ...
                            <div class="ml-4 mr-4">
                                <div class="font-medium">Document List added successfully!</div>
                            </div>
                        </div>
                        <div id="failed-notification-content" class="toastify-content hidden flex">
                            <i class="text-danger" data-lucide="x-circle"></i>
                            <div class="ml-4 mr-4">
                                <div class="font-medium">Failed Document List added!</div>
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('editDocument') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination">
                    <li class="page-item {{ $page == 1 ? 'disabled' : '' }}">
                        <a class="page-link" href="{{ route('document', ['page' => $page - 1]) }}">
                    ...
                    @for ($i = 0; $i < $totalPages; $i++)
                        <li class="page-item {{ $page == $i + 1 ? 'active' : '' }} ">
                            <a class="page-link"
                                href="{{ route('document', ['page' => $i + 1]) }}">{{ $i + 1 }}</a>
                        </li>
                    @endfor
