...
<div class="d-inline addbtn intro-y col-span-12">
    <nav class="w-full sm:w-auto sm:mr-auto">
        <ul class="pagination" id="pagination">
            ...
            @if ($startPage > 1)
                <li class="page-item"><a class="page-link" href="{{ route('dailyHoroscope', ['page' => 1, 'searchString' => $searchString]) }}">1</a></li>
            ...
            @for ($i = $startPage; $i <= $endPage; $i++)
                <li class="page-item {{ $page == $i ? 'active' : '' }}">
                    <a class="page-link"
                        href="{{ route('dailyHoroscope', ['page' => $i, 'searchString' => $searchString]) }}">{{ $i }}</a>
                </li>
            @endfor
