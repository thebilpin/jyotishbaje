                                ...
                                <a href="{{ route('front.dailyHoroscope', ['slug' => $horoscopesign['slug']]) }}"
                                    ...
                                    <div class="text-center mb-2 mb-md-0">
                                        <div class="icon border-0 bg-pink">
                                            <img class="rounded-full cursor-pointer" src="{{ Str::startsWith($horoscopesign['image'], ['http://','https://']) ? $horoscopesign['image'] : '/' . $horoscopesign['image'] }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('{{ $horoscopesign['image'] }}')" />
                                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade show active" id="dailyData">
                                ...
                                <div class="d-md-flex align-items-start">
                                    <img class="rounded-full cursor-pointer" src="{{ Str::startsWith($signRcd[0]->image, ['http://','https://']) ? $signRcd[0]->image : '/' . $signRcd[0]->image }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('{{ $signRcd[0]->image }}')" />
