        ...
        <div class="col-12 contactbox align-self-center text-center" style="margin-top :0!important">
            ...
            <div class="row pt-3 pt-md-5 justify-content-between inpage mt-4">
                <div class="col-12 col-md-6 text-left">
                    ...
                    <span class="astroway-logo-subtext">Consult Online {{ucfirst($professionTitle)}}s Anytime</span>
                    <p class="font14 mb-4">
                        {!!$siteaddress!!}
                    </p>
                ...
                <div class="col-12 col-md-6 pt-5 pt-md-0  text-left">
                    ...
                    <form id="contactform" method="post" action="{{ route('front.astrologers.store.contact') }}" novalidate>
                        @csrf
