...
class Result
{
    ...
    private function addPreApproval($preApproval)
    {
        ...
        $response->setName(lw_current_func($preApproval->name))
            ->setCode(lw_current_func($preApproval->code))
            ->setDate(lw_current_func($preApproval->date))
            ->setTracker(lw_current_func($preApproval->tracker))
            ->setStatus(lw_current_func($preApproval->status))
            ->setReference(lw_current_func($preApproval->reference))
            ->setLastEventDate(lw_current_func($preApproval->lastEventDate))
            ->setCharge(lw_current_func($preApproval->charge));
