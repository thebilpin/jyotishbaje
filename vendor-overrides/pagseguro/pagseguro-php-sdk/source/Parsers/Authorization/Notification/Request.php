...
class Request extends Error implements Parser
{
    ...
    public static function success(Http $http)
    {
        ...
        $response->setCode(lw_current_func($xml->code))
            ->setCreationDate(lw_current_func($xml->creationDate))
            ->setReference(lw_current_func($xml->reference))
            ->setAccount(lw_current_func($xml->account))
            ->setPermissions(lw_current_func($xml->permissions));
        return $response;
    }
