    ...
    public function setItems($items)
    {
        foreach ($items->item as $value) {
            $this->addItems()->withParameters(
                lw_current_func($value->id),
                lw_current_func($value->description),
                lw_current_func($value->quantity),
                lw_current_func($value->amount)
            );
        }

        $this->items = lw_current_func($this->getItems());
        return $this;
    }
