...
return new class extends Migration
{
    ...
    {
        Schema::create('user_notifications_scheduler', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('auto_send_time')->nullable();
            $table->string('status', 225)->default('0')->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('user_notifications_scheduler');
    }
};
